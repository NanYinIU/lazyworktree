...
../zh-feature-foo/       ← worktree 分组根目录
  module1/               ← module1 在 feature/foo 上的 worktree
  module4/               ← module4 在 feature/foo 上的 worktree
...
| `baseBranch.projects` | 按项目覆盖基准分支，例如 `{ "module4": "origin/release/2.0" }` |
...
Options:
  --projects <list>      逗号分隔的项目列表
                         （如 "module1,module4" 或 "module1,ypzb:bugfix-room"）
...
| 快速创建 | `lazyworktree --projects module1,module4 --feature feature/foo` |
